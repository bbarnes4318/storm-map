  ...
  return (
    <div className="fixed inset-0 z-[4000] flex items-center justify-center p-4 bg-black/80 backdrop-blur-sm select-none animate-in fade-in duration-305">
      ...
      <div className="w-full max-w-4xl bg-[#071426] border border-[rgba(20,92,255,0.25)] rounded-2xl shadow-2xl flex flex-col overflow-hidden select-text animate-in scale-in duration-300 max-h-[90vh]">
        ...
        {/* Modal Header */}
        <div className="py-2.5 px-4 border-b border-[rgba(20,92,255,0.15)] flex items-center justify-between shrink-0 bg-[#0B1930]/40">
        ...
        {formSubmitted ? (
          ...
          <form onSubmit={handleSubmit} className="flex flex-col flex-1 overflow-hidden">
            <div className="py-3 px-4 space-y-3 overflow-y-auto lg:overflow-y-hidden flex-1 custom-scrollbar">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-3.5">
                ...
                <div
                  ...
                  className={`p-3 rounded-xl border transition-all cursor-pointer text-left select-none relative flex flex-col justify-between h-full ${
                ...
                >
                  <div>
                    ...
                    <p className="text-xs text-slate-300 font-medium leading-relaxed mb-1.5">
                      Best for contractors testing a new market.
                    </p>
                    <ul className="space-y-1 text-[11px] font-bold text-slate-400 uppercase tracking-wide mb-2.5">
                  ...
                  <button
                    type="button"
                    className={`w-full py-1 rounded text-xs font-black uppercase tracking-wider transition-all border-0 cursor-pointer ${
                      preferredOption === "Month to Month Lead Plan"
                ...
                >
                  <span className="absolute -top-2 right-4 px-2 py-0.5 bg-[#10B981] text-white text-[9.5px] font-black uppercase tracking-widest rounded-full shadow-sm">
                ...
                >
                  <div>
                    ...
                    <p className="text-xs text-slate-300 font-medium leading-relaxed mb-1.5">
                      Exclusive roof inspection appointments. No charge for no-shows.
                    </p>
                    <ul className="space-y-1 text-[11px] font-bold text-slate-400 uppercase tracking-wide mb-2.5">
                      <li className="flex items-center gap-1.5"><Check size={12} className="text-[#10B981] shrink-0" /> 5 appointments minimum</li>
                      <li className="flex items-center gap-1.5"><Check size={12} className="text-[#10B981] shrink-0" /> High show rate focus (9/10 target)</li>
                    </ul>
                  </div>
                  <button
                    type="button"
              ...
              <div className="border-t border-[rgba(20,92,255,0.12)] pt-2.5 mt-0.5">
                <span className="text-[10.5px] font-black text-slate-400 uppercase tracking-widest block mb-2 pl-0.5">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-2.5">
                  ...
                  <div className="space-y-2">
                    <div className="relative">
                      <span className="absolute inset-y-0 left-3 flex items-center text-slate-555"><User size={12} /></span>
                      <input
                        type="text"
                        required
                        value={name}
                        ...
                        className="w-full bg-[#050B16] border border-slate-800 hover:border-slate-700 focus:border-[#145CFF] rounded-lg pl-9 pr-3.5 py-1 text-xs text-[#F8FAFC] placeholder:text-slate-500 focus:outline-none transition-colors font-semibold"
                      />
                    </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-2.5 mt-2">
                  ...
                  <div className="bg-[#050B16]/50 border border-slate-850 p-2 rounded-lg text-[11px] font-bold text-[#CBD5E1] flex items-center justify-between">
            ...
            {/* Modal Footer */}
            <div className="py-2.5 px-4 border-t border-[rgba(20,92,255,0.12)] flex items-center justify-end bg-[#0B1930]/40 shrink-0 gap-3">
              <button
                type="button"
                onClick={onClose}
              ...
              <button
                type="submit"
                className="px-6 py-2 bg-[#145CFF] hover:bg-[#2570FF] border-none rounded-lg text-xs font-black text-white uppercase tracking-wider flex items-center gap-1.5 cursor-pointer shadow-md shadow-[#145CFF]/15 transition-all"
              >
                <Send size={12} />
